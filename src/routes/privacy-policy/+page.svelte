<div class="flex items-center justify-center w-full">
	<div class="max-w-4xl p-5">
		...
		<p>
			At Kisara, accessible from https://kisara2.vercel.app/, one of our main priorities is the
			privacy of our visitors. This Privacy Policy document contains types of information that is
			collected and recorded by Kisara and how we use it.
		</p>
		...
		<h2 class="text-lg font-bold mt-5">Log Files</h2>

		<p>
			Kisara follows a standard procedure of using log files. These files log visitors when they
			...
			with the help of the <a href="https://www.privacypolicyonline.com/privacy-policy-generator/"
				>Privacy Policy Generator</a
			>.
		</p>

		<h2 class="text-lg font-bold mt-5">Cookies and Web Beacons</h2>

		<p>
			Like any other website, Kisara uses "cookies". These cookies are used to store information
		...
		<p>
			For more general information on cookies, please read <a
				...
				>the "Cookies" article from the Privacy Policy Generator</a
			>.
		</p>

		<h2 class="text-lg font-bold mt-5">Privacy Policies</h2>
		...
		<p>
			...
			Beacons that are used in their respective advertisements and links that appear on Kisara,
		...
		<p>
			Note that Kisara has no access to or control over these cookies that are used by third-party
			advertisers.
		</p>

		<h2 class="text-lg font-bold mt-5">Third Party Privacy Policies</h2>

		<p>
			Kisara's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising
		...
		<h2 class="text-lg font-bold mt-5">Children's Information</h2>
		...
		<p>
			Kisara does not knowingly collect any Personal Identifiable Information from children under
			the age of 13. If you think that your child provided this kind of information on our website,
			we strongly encourage you to contact us immediately and we will do our best efforts to
			promptly remove such information from our records.
		</p>

		<h2 class="text-lg font-bold mt-5">Online Privacy Policy Only</h2>

		<p>
			This Privacy Policy applies only to our online activities and is valid for visitors to our
			website with regards to the information that they shared and/or collect in Kisara. This policy
			is not applicable to any information collected offline or via channels other than this
			website.
		</p>

		<h2 class="text-lg font-bold mt-5">Consent</h2>
