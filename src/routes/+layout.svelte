...
<footer class="mt-auto bg-base-300 rounded-t-3xl w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
	...
	<div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6 mb-10">
		...
		<div>
			...
			<div class="mt-3 grid space-y-3 text-sm">
				<p>
					<a class="inline-flex gap-x-2 text-gray-400 hover:text-gray-500" href="/"
						>Help & Support</a
					>
				</p>
		...
		<div class="sm:flex sm:justify-between sm:items-center">
			<div class="flex items-center gap-x-3">
				<div class="space-x-4 text-sm ms-4">
					<a class="inline-flex gap-x-2 text-gray-400 hover:text-gray-500" href="/">Terms</a>
					<a class="inline-flex gap-x-2 text-gray-400 hover:text-gray-500" href="/privacy-policy">Privacy</a>
				</div>
			</div>
			...
			<div class="flex justify-between items-center">
				<div class="mt-10 sm:hidden">
					<a class="flex-none text-xl font-semibold" href="/" aria-label="KiSaRa">KiSaRa</a>
					<p class="mt-1 text-xs sm:text-sm text-gray-400">© 2024 Lazypeople org.</p>
				</div>
				...
				<div class="space-x-4">
					...
					<a class="inline-block text-gray-400 hover:text-gray-500" href="https://github.com/LazyyPeople">
						<svg
							class="flex-shrink-0 size-4"
							xmlns="http://www.w3.org/2000/svg"
							width="16"
